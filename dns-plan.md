...
netrunner1.infranet.netkey (hostname) - 10.2.0.5 (IP)
netrunner2.infranet.netkey (hostname) - 10.2.0.15 (IP)

# Zone File Design:

- Forward Zone name: infranet.netkey
- IP network: 10.0.2.0/24
- Reverse Zone name (PTR): 2.0.10.in-addr.arpa (octects reversed) <- learned new!
